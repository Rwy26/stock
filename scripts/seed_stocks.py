...
SEED_STOCKS: list[tuple[str, str, str, str]] = [
    ...
    ("064260", "LG씨엔에스",       "KOSPI",  "로봇·AI수혜|시스템통합"),
    ...
    ("011810", "현대로템",            "KOSPI",  "외국인수급|방산"),
    ("078930", "GS",                  "KOSPI",  "외국인수급"),
    ("384490", "달바글로벌",          "KOSDAQ", "외국인수급"),
    ...
    ("104480", "티씨케이",            "KOSDAQ", "외국인수급|반도체"),
    ("218410", "RFHIC",               "KOSDAQ", "외국인수급"),
    ("403870", "HPSP",                "KOSDAQ", "외국인수급|반도체"),
    ("108490", "로보티즈",            "KOSDAQ", "외국인수급|로봇"),
    ("040610", "성호전자",            "KOSDAQ", "외국인수급"),
    ("084370", "유진테크",            "KOSDAQ", "외국인수급|반도체"),
    ("111870", "쎄트렉아이",          "KOSDAQ", "외국인수급|우주항공"),
    ("050890", "피에스케이홀딩스",    "KOSDAQ", "외국인수급|반도체"),
    ("101490", "에스앤에스텍",        "KOSDAQ", "외국인수급|반도체"),
    ("327260", "RF머티리얼즈",        "KOSDAQ", "외국인수급"),
